...
use crate::{cmd, ConnectionInfo, ProtocolVersion, PushKind, PushInfo};
use ::tokio::{
...
pub struct MultiplexedConnection {
    ...
    //pubsub_subscriptions: Arc<ArcSwap<PushManager>>,
}
...
impl MultiplexedConnection {
    ...
    {
        Self::new_with_response_timeout(connection_info, stream, std::time::Duration::MAX, push_sender).await
    }
